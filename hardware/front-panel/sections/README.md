...
| Section | Routes | Nets |
|---|---|---|
| **A** | Analog signals: link J1 to the SMA field and the TX coil terminal | 13 |
| **B** | Digital outputs, trigger and LEDs: link J2 to the TTL strip J31, the FAST1/FAST2 and TRIG SMAs, D1-D3 | 16 |
| **C** | Module outputs: link J3 to the pull-downs R491-R498, the 74AHCT541 U410, the series resistors R481-R488 and the module header J40 | 25 |
| **D** | Isolated inputs, 3.3 V and I2C: terminals J411/J412 to the 6N137 chains and link J3; +3V3 to every part; I2C from J2 to the OLED J30 and the Qwiic J33 | 19 |
