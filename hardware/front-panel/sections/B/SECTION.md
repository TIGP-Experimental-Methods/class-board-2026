# Front panel — section B

**Digital outputs, trigger and LEDs: link J2 to the TTL strip J31, the FAST1/FAST2 and TRIG SMAs, D1-D3.**
...
Hand-in: commit `hardware/front-panel/sections/B/front-panel.kicad_pcb` on your branch from the Source Control panel and ask the
