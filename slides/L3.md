...
- **Videos, slides, reports with AI** — the lab's `show-your-work` skills (`education-video`, `slide-deck`, `technical-report`, `showoff-render`): *live demo*
...
| | Due |
|---|---|
| **E11** driver + panel PR — all commands, one value plotted, the alarm rule, CI green; ring review comment-only (V6 first) | **Fri 9 Oct** |
| **E12** `box.stl` in your folder | Fri 9 Oct |
