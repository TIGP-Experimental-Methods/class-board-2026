...
**E1a · Build**
your topic, your repo · five-line `SPEC.md` — learner outcome + one result worked out by hand before the code exists · plan · one `index.html` · the check · commit
...
<span class="small">`--public` or `--private` — your choice. Cloudflare Pages deploys private repos too; the GitHub Pages fallback needs a public one.</span>
...
- [ ] **E2 finish + merge** — merge once reviewed
