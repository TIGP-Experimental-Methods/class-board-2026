...
**E2 · Your phone app measures your ESP32 (33 min)**
...
<span class="small">Grading: this part of the course is taught, not ranked — everyone who does the exercises, ships their block and demos it gets full marks. Feedback is on the work, in your PRs.</span>
...
- [ ] **E3 read your block** — V3 (8 min), two answers **and the design number** in `notes.md` (0.75 h)
- [ ] **E4 KiCad ready** — V4, install KiCad 10 (the library is in the repo), screenshot your zone (0.5 h)
- [ ] **E5 your SPEC paragraph** — what, **the number you will measure**, how you show it (0.25 h)
- [ ] reading (0.2 h)
