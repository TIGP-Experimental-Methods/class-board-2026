...
The TTL and fast-output screw terminals are not on your sheet: those lines leave your section through the link to the front panel, which the instructor owns. `hardware/docs/student-deletions.md` is the authority for this list and says where each part sits on the PDF. Your **one part from the JLCPCB parts library** (JLCPCB is the factory that makes and assembles our boards; its part numbers look like C12345): the **AD9834BRUZ, C116589**, TSSOP-20 — the synthesizer U801 itself.
