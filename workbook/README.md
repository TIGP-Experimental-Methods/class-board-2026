...
| [Your section of the class board](blocks/) — [Section A: inputs and the NMR receiver](blocks/a.md) · [Section B: signal generation, timing and the NMR transmitter](blocks/b.md) · [Section C: the front panel board](blocks/c.md) | assigned at the start of Workshop 2 | inside `/tutor L2`, `/tutor HW2` |
