...
One source for two readers: **you** (read it like a lab manual) and **the tutor** (`/tutor <chapter>` in Claude Code reads the same chapter and paces you through it, in English or Mandarin). Every chapter is time-boxed, has checkboxes, the exact commands, and a *what you should see* line after every step.

The budget is a promise: **10 hours of homework in total** (2.5 + 3 + 3 + 1.5) plus three 2-hour sessions. Videos count inside the 10 h; the ≤ 1 h pre-class setup does not.

| Chapter | When | Time | `/tutor` |
|---|---|---|---|
| [0 — Before day 1](ch0-before-day-1.md) | before Fri 09-11 | ≤ 1 h (uncounted) | `/tutor CH0` |
| [1 — Day 1 + week 1: build it, ship it, log it — then your instrument](ch1-day-1-week-1.md) | Fri 09-11 + HW1 | 2 h + 2.5 h | `/tutor L1`, `/tutor HW1` |
| [2 — Day 2 + week 2: your part of the board](ch2-day-2-week-2.md) | Fri 09-18 + HW2 | 2 h + 3 h | `/tutor L2`, `/tutor HW2` |
| [3 — Day 3 + week 3: make it work, make it yours](ch3-day-3-week-3.md) | Fri 10-02 + HW3 | 2 h + 3 h | `/tutor L3`, `/tutor HW3` |
| [4 — Wrap-up + demo](ch4-wrap-up-demo.md) | week of 10-19; demos 10-26 | 1.5 h + slot | `/tutor WRAP`, `/tutor DEMO` |
| [A — Electronics from zero](chA-electronics-from-zero.md) | self-study, before L2 | optional | `/tutor A` |
| [B — How the instrument's software works](chB-how-the-software-works.md) | self-study, before L3 | optional | `/tutor B` |
