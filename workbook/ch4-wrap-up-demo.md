...
5. **Beyond the baseline (optional)** — anything you built that the course did not ask for: a data logger, a LINE alert, a PID block, a Python sweep, the tool your lab needed. Show it if you have it; nothing if you don't.

**Demo script:** who you are, which block · what the instrument is (one sentence) · items 1–3 (shared with the class) · your block · your number and what surprised you · item 5 if you have one.
