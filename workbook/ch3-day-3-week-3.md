...
**Fri 2026-10-02, 14:20–16:20 (2 h) + Homework 3 (3 h).** The board is on order (placed 09-28, back ≈ 10-12); **everything today runs in sim mode on your dev board**. You write your block's driver and its phone panel — the E2 app grown into a real block panel — and design your box from the instructor's template.
...
### A.3 Exercise E11 — driver + panel in sim (20–60 min; finished in HW3)
...
### A.5 Boxes for electronics (65–75 min)
...
### A.6 Exercise E12 (start) — your box (75–105 min)
...
### A.7 Tips and what else (105–120)
...
## Part B — Homework 3 (3 h) — `/tutor HW3`

- [ ] **E11 Driver + panel PR by Fri 10-09 (1.8 h).** All your commands; **one status value plotted** (pick it in the chart dropdown, screenshot); **the alarm rule**; CI green; PR reviewed by your ring reviewer (comment only, no second fix round). Watch V6 *A block driver + app panel, end to end, in sim mode* (10 min) first. Fill the `#ifndef SIM` branches as far as you can from the datasheet with `TODO` where you must measure first — pins only from `firmware/include/pins.h`.
