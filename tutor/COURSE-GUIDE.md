...
8. **Escalate when stuck.** Write the exact error into `PROGRESS.md` gotchas, tell the student to post it in the course LINE group with a screenshot, and continue with the next step that does not depend on it. Office hour: Wed 16:00.
