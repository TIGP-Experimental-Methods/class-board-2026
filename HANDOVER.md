...
> **2026-09-06 (course session, later):** **no office hour** (never agreed — removed everywhere); tutor rule 8 = the fix on request only, after 15 minutes stuck (never volunteered), then the LINE group; rule 3 = homework must stay short; setup advice = "stuck on any setup problem → ask for help in the LINE group" (no "come early").
